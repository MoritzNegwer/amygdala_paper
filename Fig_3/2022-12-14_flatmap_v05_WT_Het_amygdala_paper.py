...
output_dir = '/home/wirrbel/2022-11-09_cortical_flatmap_test/flatmaps_5_amygdala_paper'
...
def summarize_all_cells_per_group_as_10_um_nrrd(mouse_list,output_dir,output_name):
    ...
    #TODO: resample to 10um spacing (avg 10 um atlas has coordinates x=1320, y=800, z=1140)
    ...
    #heatmap_8bit = img_as_ubyte(heatmap)
    #save tiff stack
...
'''
#==== P14 ====
WorkFoldersP14_WT = [['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m1/','WT',14],
               ['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m2/','WT',14],
               ['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m3/','WT',14],
               #['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m4/','Het',14],
               ['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m5/','WT',14],
               ['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m1_66632/','WT',14],
               ['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m2_66633/','WT',14],
               #['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m3_66634/','Het',14],
               #['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m4_66635/','Het',14],
               #['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m5_190925/','Het',14],
               ['/media/wirrbel/MN_2/Lukas_PV_P14/Lukas_PV_P14_m6_190926/','WT',14]
               ]

PV_P14_nrrd_WT = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersP14_WT,output_dir,'PV_P14_WT')

WorkFoldersP14_Het = [#['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m1/','WT',14],
               #['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m2/','WT',14],
               #['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m3/','WT',14],
               ['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m4/','Het',14],
               #['/media/wirrbel/MN_2/Lynn_PV_P14/2020-03-02_Lynn_PV_P14_m5/','WT',14],
...
PV_P14_nrrd_Het = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersP14_Het,output_dir,'PV_P14_Het')
'''

# ==== Didn't work, take CCF3-aligned ones from big HDD 
'''
#==== P56 ==== 
WorkFoldersP56_Het = [['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m1/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m2/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m3/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m4/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m5/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-17_Lynn_PV_P50_m2/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-19_Lynn_PV_P50_m3/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-19_Lynn_PV_P50_m5/','Het',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-24_Lynn_PV_P50_m8/','Het',56]
               ]
    
PV_P56_nrrd_Het = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersP56_Het,output_dir,'PV_P56_Het')

WorkFoldersP56_WT = [['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m6/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m7/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/Lukas_PV_50_m8/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-17_Lynn_PV_P50_m1/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-19_Lynn_PV_P50_m4/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-19_Lynn_PV_P50_m6/','WT',56],
               ['/media/wirrbel/MN_4/Amygdala_paper_collection/Lynn_PV_P50/2020-02-24_Lynn_PV_P50_m7/','WT',56],
               ]
    
PV_P56_nrrd_WT = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersP56_WT,output_dir,'PV_P56_WT')


#===SST===
'''
WorkFoldersSST_Het = [["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-23_SST_P25_Sample1_57645_Het/", 'Het',28], #Het
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-25_SST_P25_Sample4_57648_Het/", 'Het',28], #Het
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-26_SST_P25_Sample6_57657_Het/", 'Het',28], #Het
               ]
    
SST_P28_nrrd_Het = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersSST_Het,output_dir,'SST_P28_Het')
'''
WorkFoldersSST_WT = [["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-24_SST_P25_Sample2_57646_WT/", 'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-25_SST_P25_Sample3_57647_WT/", 'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/SST_Maren/2019-04-26_SST_P25_Sample5_57654_WT/", 'WT',28], #WT
               ]
    
SST_P28_nrrd_WT = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersSST_WT,output_dir,'SST_P28_WT')

#===VIP===
WorkFoldersVIP_Het = [["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_docker/Lynn_VIP_P26_m69368_Het/", 'Het', 28], #Het
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m2/", 'Het', 28], #Het
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m4/", 'Het',28], #Het
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m6/", 'Het',28], #Het
                ]
VIP_P28_nnrd_Het = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersVIP_Het,output_dir,'VIP_P28_Het')

WorkFoldersVIP_WT = [["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_docker/Lynn_VIP_P26_m69366_WT/", 'WT', 28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_docker/Lynn_VIP_P26_m69369_WT/VIP_P26_m69369_WT_tdtom/",'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_docker/Lynn_VIP_P26_m69370_WT/",'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_docker/Lynn_VIP_P26_m69371_WT/", 'WT', 28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m1/", 'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m3/", 'WT',28], #WT
               ["/media/wirrbel/MN_4/Amygdala_paper_collection/VIP_Arivis/m5/", 'WT',28], #WT
                ]
VIP_P28_nnrd_WT = summarize_all_cells_per_group_as_10_um_nrrd(WorkFoldersVIP_WT,output_dir,'VIP_P28_WT')
'''
...
def layer_flatmap(tlx_normalized_layers, bf_left_boundaries, bf_right_boundaries, layer_top,layer_bottom,heatmap_name,layer_title,output_dir,scale_colormap=True,vmax=0.01,colormap="inferno"):
...
# if still generating, the nrrd object is already loaded 

#if already produced: load heatmaps (optional, but might save time)
PV_P14_nrrd_WT = os.path.join(output_dir,'PV_P14_WT'+'.nrrd')
PV_P14_nrrd_Het = os.path.join(output_dir,'PV_P14_Het'+'.nrrd')
PV_P56_nrrd_Het = os.path.join(output_dir,'PV_P56_Het'+'.nrrd')
PV_P56_nrrd_WT = os.path.join(output_dir,'PV_P56_WT'+'.nrrd')
SST_P28_nrrd_Het = os.path.join(output_dir,'SST_P28_Het'+'.nrrd')
SST_P28_nrrd_WT = os.path.join(output_dir,'SST_P28_WT'+'.nrrd')
VIP_P28_nnrd_Het = os.path.join(output_dir,'VIP_P28_Het'+'.nrrd')
VIP_P28_nnrd_WT = os.path.join(output_dir,'VIP_P28_WT'+'.nrrd')

all_nrrds = [#[PV_P14_nrrd_WT,'PV_P14_WT',0.01],
             #[PV_P14_nrrd_Het,'PV_P14_Het',0.01],
             #[PV_P56_nrrd_Het,'PV_P56_Het',0.02],
             #[PV_P56_nrrd_WT,'PV_P56_WT',0.02],
             [SST_P28_nrrd_Het,'SST_P28_Het',0.01],
             #[SST_P28_nrrd_WT,'SST_P28_WT',0.01],
             #[VIP_P28_nnrd_Het,'VIP_P28_Het',0.01],
             #[VIP_P28_nnrd_WT,'VIP_P28_WT',0.01],
             ]
...
for nrrd_file,heatmap_name,vmax in all_nrrds:
    ...
    for layer_top,layer_bottom,layer_title in layers_flatmap_list:
        layer_flatmap(tlx_normalized_layers, bf_left_boundaries, bf_right_boundaries, layer_top,layer_bottom,heatmap_name,layer_title,output_dir,scale_colormap=False,vmax=vmax,colormap="inferno")
